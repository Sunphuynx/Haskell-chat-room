...
#ifndef VERSION_haskell_chat_room
#define VERSION_haskell_chat_room "0.1.0.0"
#endif /* VERSION_haskell_chat_room */
#ifndef MIN_VERSION_haskell_chat_room
#define MIN_VERSION_haskell_chat_room(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_chat_room */
/* package async-2.2.5 */
...
#define CURRENT_PACKAGE_KEY "haskell-chat-room-0.1.0.0-CvWfPbm5NwS4IHkUBEqGCz"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-chat-room-0.1.0.0-CvWfPbm5NwS4IHkUBEqGCz"
